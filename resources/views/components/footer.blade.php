<footer class="w-full bg-black text-white pt-16 mt-20">
    <div class="grid grid-cols-3 px-20 md:px-60 gap-10 mb-10">
        ...
        <div class="col-span-3 md:col-span-1 text-center md:text-left">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda blanditiis doloremque esse eum
        ...
        <div class="col-span-3 md:col-span-1 text-center md:text-left">
            ...
            <div class="flex gap-2">
                <a href="">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 fill-white hover:fill-red-600" viewBox="0 0 24 24">
                        <path
    ...
    <div class="py-5 md:px-60 px-20 border-t-2 border-white text-center w-1/2 mx-auto">
