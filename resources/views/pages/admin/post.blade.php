...
<x-app>
    ...
    <x-dashboard-shell>
        <div class="w-full grid grid-cols-4 gap-10">
            ...
            <div
                class="col-span-4 w-full space-y-2">
            ...
            <div class="col-span-4 xl:col-span-3 space-y-2" style="height: fit-content">
            ...
            <div class="col-span-4 xl:col-span-1 flex flex-col space-y-2">
                <h2 class="text-3xl font-bold text-primary rounded-lg w-fit">
                Actions
                </h2>
                <form
