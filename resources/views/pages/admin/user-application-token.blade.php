<x-app>
    ...
    <x-dashboard-shell>
        <div class="">
            <h1 class="text-4xl font-medium">Token Management</h1>
            <div class="my-4 flex justify-end">
                <a href="{{ route('admin.application.token-generate') }}" class="inline-flex items-center gap-1 rounded-lg border border-blue-500 bg-blue-500 px-5 py-2.5 text-center text-md font-medium text-white shadow-sm transition-all hover:border-blue-700 hover:bg-blue-700 focus:ring focus:ring-blue-200 disabled:cursor-not-allowed disabled:border-blue-300 disabled:bg-blue-300">
