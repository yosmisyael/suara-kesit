    ...
    <x-dashboard-shell>
        <div x-data="{ showModal: false, userId: null, username: null, confirmed: false } " class="relative">
            ...
            <header class="text-black">
                ...
                <h1 class="text-5xl font-black md:text-7xl">Author</h1>
                <p class="text-lg">List all user with role author.</p>
            </header>
            ...
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500 shadow-md rounded-xl">
                ...
                <tr>
                    ...
                    <th scope="col" class="px-6 py-4 font-medium text-gray-900">Promoted on</th>
            ...
            @if($users->count() == 0)
                <p class="text-center mt-5">There is no author that has been registered yet.</p>
            @endif
