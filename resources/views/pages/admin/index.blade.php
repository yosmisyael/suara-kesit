<x-app>
    ...
    <x-dashboard-shell>
        <div class="grid grid-cols-1 gap-4 mb-4">
            ...
            >
                <h2 class="text-lg lg:text-2xl font-medium text-gray-600">Hallo, Administrator, welcome back</h2>
                <h1 class="text-3xl lg:text-5xl font-medium">Administrator Dashboard Overview</h1>
            </div>
        </div>
                ...
                <div class="bg-pink-50 shadow-lg p-5 rounded-lg flex flex-col gap-5">
                    ...
                    <div class="text-2xl font-semibold flex gap-2 items-center bg-pink-100 p-2 rounded-lg">
                        ...
                        <div class="flex flex-col">
                            ...
                            <h4 class="text-2xl font-bold text-contrary flex gap-3">
                                <span class="block">How to train a ...</span>
                                <a href=""
                                   class="hover:bg-pink-200 cursor-pointer flex items-center rounded-sm w-7 h-7 rounded-lg">
