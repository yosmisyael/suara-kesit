<div>
    ...
    <div x-on:keydown.window.escape="showModal = false">
        <div x-cloak x-transition.opacity class="fixed inset-0 z-10 bg-secondary-700/50"></div>
        <div x-cloak x-transition class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0">
            <div class="mx-auto w-full overflow-hidden rounded-lg bg-white shadow-xl sm:max-w-sm">
                <div class="relative p-5">
                    ...
                    <div class="mt-5 flex justify-end gap-3">
                        ...
                        <form action="{{ route('admin.user.delete', ['id' => $id]) }}" method="post" class="flex-1">
                            @csrf
                            @method('DELETE')
